        ...
        <Link
          ...
          onClick={(e) => {
            if (window.isNavigationBlocked) {
              e.preventDefault();
              window.dispatchEvent(new CustomEvent('vaani:request-exit'));
            }
          }}
        ...
        <div className="flex items-center gap-3" ref={menuRef}>
          ...
          <div className="relative">
            <button
              ...
              className={`flex items-center justify-center w-10 h-10 md:w-auto md:h-auto md:px-3 md:py-2 rounded-xl transition-all duration-300 ${isOpen
